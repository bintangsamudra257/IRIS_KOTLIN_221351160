package com.example.iris_kotlin_221351160
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        edtSepalLengthCm = findViewById(R.id.edtSepalLength)
        edtSepalWidthCm = findViewById(R.id.edtSepalWidth)
        edtPetalLengthCm = findViewById(R.id.edtPetalLength)
        edtPetalWidthCm = findViewById(R.id.edtPetalWidth)
